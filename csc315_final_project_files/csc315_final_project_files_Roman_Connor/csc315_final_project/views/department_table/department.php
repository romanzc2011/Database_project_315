...
<?php session_start(); ?>
<?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/controller/department_controller/department_processor.php'); ?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container-fluid" id="cover_page">
        ...
        <div class="row between-xs" id="index_header">
            <div class="col-sm-11 m-4 d-grid gap-4 rcorner-sm border-success lt-purple">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/department_table/department_header.php'); ?>
            </div>

            <div class="col-sm-3 d-grid gap-3 p-4 height">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/department_table/department_buttons/department_buttons.php'); ?>
            </div>
            <div class="col-sm-7 rcorner" id="index_div">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/department_table/department_page.php'); ?>
            </div>
        </div>
</form>
