...
<?php session_start(); ?>
<?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/controller/grade_controller/grade_processor.php'); ?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container-fluid" id="cover_page">
        ...
        <div class="row between-xs" id="index_header">
            <div class="col-sm-11 m-4 d-grid gap-4 rcorner-sm border-success lt-purple">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/semester_table/semester_header.php'); ?>
            </div>

            <div class="col-sm-3 d-grid gap-3 p-4 height">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/semester_table/semester_buttons/semester_buttons.php'); ?>
            </div>
            <div class="col-sm-7 rcorner" id="index_div">
                <?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/views/semester_table/semester_page.php'); ?>
            </div>
        </div>
</form>
<img src="../../img/lsus-logo.png" style="position:absolute;bottom:-125px;left:100px;z-index:1" height="120" />
<script><?php require($_SERVER['DOCUMENT_ROOT'] . '/csc315_final_project/js/semester_page.js'); ?></script>